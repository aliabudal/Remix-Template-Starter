...
export const HeroSection: FC = () => {
    return (
      <section className="mx-auto flex max-w-8xl flex-col items-center justify-center overflow-hidden px-4 py-12 sm:py-16 lg:px-20">
          ...
          <div className="grid gap-8">
            <div className="flex flex-col items-center justify-center gap-4 text-center xl:max-w-[676px]">
              <h1 className="max-w-3xl text-4xl font-extrabold leading-none text-gray-900 dark:text-white lg:text-5xl xl:text-6xl">
                <span className="block">Build modern web applications with</span>
            ...
            <p className="max-w-3xl text-lg leading-normal text-gray-500 dark:text-gray-400 lg:text-xl">
                This template is a open-source project built mainly on top of Remix, TypeScript, Tailwind CSS, and Vite.
                It&apos;s a great starting point for building modern web applications.
            </p>
              <div className="mt-6 grid w-full max-w-xl grid-cols-1 gap-4">
                ...
                <div className="flex justify-center">
                  ...
                  >
                    Get started <HobbyKnifeIcon className="ml-2 mt-1 h-4 w-4" />
                  </Link>
                </div>
              </div>
            </div>
